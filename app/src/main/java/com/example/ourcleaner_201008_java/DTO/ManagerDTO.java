...
public class ManagerDTO implements Serializable {
    ...
    public ManagerDTO(int id, String email, String nameStr, String phoneNumStr, String addressStr, ArrayList<String> desiredWorkAreaList, String imagePathStr, long reviewStarLong, ArrayList<ReviewDTO> reviewDTOArrayList) {
        this.id = id;
        this.email = email;
